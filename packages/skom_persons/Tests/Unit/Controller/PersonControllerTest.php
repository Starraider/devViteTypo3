...
namespace SKom\SkomPersons\Tests\Unit\Controller;
...
{
    /**
     * @var \SKom\SkomPersons\Controller\PersonController|MockObject|AccessibleObjectInterface
     */
    protected $subject;
    ...
    {
        parent::setUp();
        $this->subject = $this->getMockBuilder($this->buildAccessibleProxy(\SKom\SkomPersons\Controller\PersonController::class))
    ...
    public function listActionFetchesAllpeopleFromRepositoryAndAssignsThemToView(): void
    {
        ...
        $personRepository = $this->getMockBuilder(\SKom\SkomPersons\Domain\Repository\PersonRepository::class)
            ->onlyMethods(['findAll'])
            ->disableOriginalConstructor()
            ->getMock();
    ...
    {
        $person = new \SKom\SkomPersons\Domain\Model\Person();
