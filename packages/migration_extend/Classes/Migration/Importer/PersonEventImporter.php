...
/**
 * Class PersonEventImporter
 */
class PersonEventImporter extends AbstractImporter implements ImporterInterface
{
     ...
     * @var string
     */
    protected string $tableName = 'tx_leseohren_event_person_mm';
