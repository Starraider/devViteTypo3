...
/**
 * Class GetMandatsreferenzPropertyHelper
 */
class GetMandatsreferenzPropertyHelper extends AbstractPropertyHelper implements PropertyHelperInterface
{
    /**
    ...
    public function manipulate(): void
    {
        ...
        $sql = 'SELECT Mandatsreferenz FROM 01_Mitglieder WHERE Personen=' . (int)$this->getPropertyFromRecord('_migrated_uid');
