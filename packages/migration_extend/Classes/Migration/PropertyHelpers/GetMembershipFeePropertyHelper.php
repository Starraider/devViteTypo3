...
/**
 * Class GetMembershipFeePropertyHelper
 */
class GetMembershipFeePropertyHelper extends AbstractPropertyHelper implements PropertyHelperInterface
{
    /**
    ...
    public function manipulate(): void
    {
        ...
        $sql = 'SELECT Jahresbeitrag FROM 01_Mitglieder WHERE Personen=' . (int)$this->getPropertyFromRecord('_migrated_uid');
