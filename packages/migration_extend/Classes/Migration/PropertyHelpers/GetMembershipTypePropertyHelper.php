...
/**
 * Class GetMembershipTypePropertyHelper
 */
class GetMembershipTypePropertyHelper extends AbstractPropertyHelper implements PropertyHelperInterface
{
    /**
    ...
    public function manipulate(): void
    {
        ...
        $sql = 'SELECT Mitgliedschaftsarten FROM 01_Mitglieder WHERE Personen=' . (int)$this->getPropertyFromRecord('_migrated_uid');
