 ...
 */
class GetBanknamePropertyHelper extends AbstractPropertyHelper implements PropertyHelperInterface
{
    /**
    ...
    public function manipulate(): void
    {
        ...
        $sql = 'SELECT Bank FROM 01_Mitglieder WHERE Personen=' . (int)$this->getPropertyFromRecord('_migrated_uid');
